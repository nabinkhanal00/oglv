...
int main() {
	...
	ResourceManager::LoadShader("shaders/lightsource/vertex.glsl",
	                            ...
	                            "lightShader");
	ResourceManager::LoadShader("shaders/basic/vertex.glsl",
	                            "shaders/basic/fragment.glsl", "tracer");
	...
	while (glfwWindowShouldClose(window) == false) {
		...
		Context::mousePos.x = mouseX;
		Context::mousePos.y = mouseY;
		...
		if (current == 1) {
			...
			ImGui::SliderFloat(
			    ...
			    1.0f); // Edit 1 float using a slider from 0.0f to 1.0f
			ImGui::SliderFloat(
			    "Diffuse Strength", &diffuseStrength, 0.0f,
			    1.0f); // Edit 1 float using a slider from 0.0f to 1.0f
			ImGui::SliderFloat(
			...
			ImGui::SliderInt(
			    ...
			    256); // Edit 1 float using a slider from 0.0f to 1.0f
			light.position.x = lightPosX;
			light.position.y = lightPosY;
			light.position.z = lightPosZ;
